...
with open(r"C:\Users\tmizu\マイドライブ\GitHub\claude-code\otona-match.com\outputs\tinder-531-original.html", "w", encoding="utf-8") as f:
    f.write(content)
...
with open(r"C:\Users\tmizu\マイドライブ\GitHub\claude-code\otona-match.com\outputs\tinder-531-updated.html", "w", encoding="utf-8") as f:
    f.write(new_content)
