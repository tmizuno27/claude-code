...
詳細な出品ガイドラインは `product-factory/docs/architecture.md` および `gumroad-notion/docs/gumroad-listing-guide.md` を必ず読み込んでから作業を開始すること。
...
- 参照: `gumroad-notion/scripts/generate_thumbnails.py`
