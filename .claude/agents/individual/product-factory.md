...
## カテゴリ別参照先
- gumroad-notion: `products/gumroad-notion/listings/01-freelance-business-os.md`（フォーマット参照）
- rapidapi: `products/api-services/01-qr-code-api/`（構造参照）
- chrome-ext: `products/chrome-extensions/json-formatter/`（構造参照）
- vscode-ext: `products/vscode-extensions/paste-and-transform/`（構造参照）
