...
- **対象パス**:
  - `claude-code/nambei-oyaji.com/scripts/` — 記事生成・投稿・分析
  - `claude-code/otona-match.com/scripts/` — 同上
  - `claude-code/sim-hikaku.online/scripts/` — 同上
  - `claude-code/tools/` — ユーティリティ（sheets-sync等）
- **品質基準**:
...
- **対象**:
  - `claude-code/api-services/` — 21 Workers
  - `claude-code/wp-linker/` — Vercel
  - `claude-code/pseo-saas/` — Vercel
...
- `claude-code/tools/healthchecks/` — Healthchecks.io設定
- `claude-code/nambei-oyaji.com/scripts/` — ブログ自動化（Python）
- `claude-code/otona-match.com/scripts/` — 同上
- `claude-code/sim-hikaku.online/scripts/` — 同上
- `claude-code/tools/sheets-sync/` — Google Sheets同期
