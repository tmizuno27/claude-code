...
2. 各プラットフォームの既存商品数を確認:
   - `products/gumroad-notion/listings/` — Notionテンプレート
   - `products/api-services/` — RapidAPI Workers
   - `products/chrome-extensions/` — Chrome拡張
   - `products/vscode-extensions/` — VS Code拡張
