...
- **RapidAPI**: `claude-code/products/api-services/01-*` 〜 `21-*` — Cloudflare Workers 21本
- **Apify Actors**: `claude-code/products/api-services/apify-actors/` — 5 Actor
- **MCP**: `claude-code/infrastructure/tools/x-mcp/` — X API MCP等
