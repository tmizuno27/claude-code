...
- **設定読み込み**: `nambei-oyaji.com/CLAUDE.md`, `config/`, `outputs/article-management.csv`

### Teammate 2: otona-match.com 監査担当
- **対象**: otona-match.com（マッチングアプリ比較サイト）
- **設定読み込み**: `otona-match.com/CLAUDE.md`, `config/`, `outputs/article-management.csv`

### Teammate 3: sim-hikaku.online 監査担当
- **対象**: sim-hikaku.online（格安SIM比較サイト）
- **設定読み込み**: `sim-hikaku.online/CLAUDE.md`, `config/`, `outputs/article-management.csv`
