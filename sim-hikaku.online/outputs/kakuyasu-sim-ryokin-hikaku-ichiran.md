...
description: "格安SIM20社の月額料金を容量別に徹底比較。1GB〜無制限まで最安プランが一目でわかる一覧表付き。2026年3月最新の税込料金で解説。"
slug: "kakuyasu-sim-ryokin-hikaku-ichiran"
category: "ryokin-hikaku"
type: "pillar"
main_kw: "格安SIM 料金比較 一覧"
status: "draft"
created: "2026-03-14"
word_count: 9200
---
...
- **1〜3GB最安** → 日本通信SIM「合理的シンプル290」<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>月額290円</strong></span>
- **10GB最安** → HISモバイル「自由自在2.0プラン」<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>月額990円（7GB）</strong></span>
- **20GB最安** → 日本通信SIM「合理的みんなのプラン」<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>月額1,390円</strong></span>
- **無制限最安** → 楽天モバイル「Rakuten最強プラン」<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>月額3,278円</strong></span>
- **かけ放題最安** → 日本通信SIM「合理的かけほプラン」<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>月額2,728円（3GB+かけ放題）</strong></span>
...
この記事では、<span style="background: linear-gradient(transparent 60%, #d6e4ff 60%)"><strong>主要20社以上の格安SIMを「容量別」に料金だけで並べた一覧表</strong></span>を用意しました。自分が毎月使うギガ数さえわかっていれば、最安プランが一目でわかります。
...
| **LINEMO** | ソフトバンク | 990円(3GB) | 2,090円(10GB) | 2,728円(30GB※) | — | 22円/30秒 | ★★★★ |
...
※ワイモバイルは現在「シンプル3」プランを提供中（シンプル2は2025年9月に新規受付終了）。割引前の料金を掲載<br>
※LINEMOは「ベストプラン」の従量制（〜3GB:990円、〜10GB:2,090円）。30GBは「ベストプランV」<br>
※povo2.0はトッピング制のため都度購入。サブスクトッピング（月5GB:1,380円/月30GB:2,780円）も選択可<br>
※IIJmioは2026年3月より15GBプランが1,800円→1,600円に値下げ<br>
※日本通信SIM「合理的みんなのプラン」は20GBで1,390円（5分かけ放題付き）

<span style="background: linear-gradient(transparent 60%, #ffd6e7 60%)"><strong>注意：上記は割引適用前の基本料金です。家族割・セット割で大幅に変わるキャリアもあります。</strong></span>

> 容量別に「自分にとっての最安」をもっと詳しく知りたい方は、[用途別の格安SIM選び方ガイド](/yoto-betsu-kakuyasu-sim-erabikata/)もあわせてどうぞ。
...
<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>業界最安クラスの月額290円</strong></span>。データ容量は1GBですが、追加は1GBあたり220円で購入可能。ドコモ回線なのでエリアも広く、とにかく固定費を抑えたい人にぴったりです。
...
- **データ容量**: 〜3GB（従量制、10GBまで2,090円）
- **通話料**: 22円/30秒（5分かけ放題550円/月）
- **回線**: ソフトバンク

### 第5位：IIJmio「ギガプラン 2GB」— 月額850円

老舗MVNOの安定感。2GBで850円、5GBでも990円と段階的に選べる柔軟さが強み。eSIM対応・端末セールも充実しており、初めての格安SIMにもおすすめ。

- **データ容量**: 2GB（5GB:950円、10GB:1,400円）
- **通話料**: 11円/30秒
- **回線**: ドコモ/au

**※最新の料金やキャンペーンは、各社の公式サイトで必ずご確認ください。**

> サブ回線として格安SIMを検討中の方は、[サブ回線におすすめの格安SIM](/sub-kaisen-kakuyasu-sim-osusume/)の記事も参考にしてください。
...
<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>7GBで990円は10GB未満帯の最強コスパ</strong></span>。厳密には10GBではなく7GBですが、多くの人は7GBで十分足ります。10GBが必要なら1,340円のプランも用意されています。
...
<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>20GBで1,390円、しかも5分かけ放題付き</strong></span>。コスパだけで言えば20GB帯のチャンピオン。ドコモ回線で速度も安定しています。

### 第2位：NUROモバイル「VLLプラン」— 月額1,790円（15GB）

厳密には15GBですが、Gigaプラス（3ヶ月ごとに3GB追加）を含めると実質18GB相当。月1,790円は15GB帯の最安水準。

### 第3位：IIJmio — 月額2,000円（20GB）

20GBで2,000円。IIJmioは2026年3月に15GBプランを1,600円に値下げするなど、積極的な価格攻勢を続けています。

### 第4位：イオンモバイル — 月額1,958円（20GB）

20GBで1,958円と、IIJmioより42円安い。しかも店舗サポートあり。「安さ+安心」の両取りができます。

### 第5位：mineo — 月額2,178円（20GB）

20GBで2,178円。マイネオ独自の「パケット放題Plus」（月385円追加で最大1.5Mbps使い放題）を組み合わせれば、実質的なデータ無制限に近い使い方も可能。
...
<span style="background: linear-gradient(transparent 60%, #d6e4ff 60%)"><strong>データ完全無制限で月額3,278円は、全キャリア通じて最安</strong></span>。段階制料金なので、使わない月は1,078円（〜3GB）まで自動で下がるのも大きなメリットです。

- Rakuten Linkアプリ使用で国内通話も無料
- 楽天エリアは人口カバー率99.9%に到達
- パートナー回線（au）も無制限に
...
速度制限はありますが、<span style="background: linear-gradient(transparent 60%, #d6e4ff 60%)"><strong>月額990円でデータ使い放題</strong></span>。最大1.5Mbpsなので、SNSやWeb閲覧、音楽ストリーミングは快適。動画は画質を落とせば視聴可能。月〜金の12時台は最大32kbpsに制限される点に注意。
...
<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>Rakuten Linkアプリを使えば通話料は完全無料</strong></span>。追加オプション不要で、国内通話が時間無制限でかけ放題。データ3GB以下なら月額1,078円で通話し放題という驚異的なコスパ。
...
ワイモバイルの「家族割引サービス」は2回線目以降が毎月1,100円割引。シンプル3 Sプラン（5GB）なら<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>割引後1,265円/人</strong></span>で使えます。さらに「おうち割 光セット（A）」との併用で最大1,650円引きも。

**家族4人の場合**: 1人目2,365円 + 2〜4人目1,265円×3 = 合計6,160円（1人あたり約1,540円）
...
IIJmioのギガプランは同一mioID内で最大10回線まで契約可能で、データ容量をシェアできます。家族4人で20GBプラン（2,000円）+追加SIM3枚で、実質1人500円程度にすることも可能。

<span style="background: linear-gradient(transparent 60%, #ffd6e7 60%)"><strong>注意：家族割・セット割は条件が複雑な場合があります。適用条件は必ず公式サイトで確認してください。</strong></span>


## 料金だけで選ぶと失敗する3つの理由

ここまで料金比較を徹底的にやってきましたが、正直に言うと、<span style="background: linear-gradient(transparent 60%, #ffd6e7 60%)"><strong>料金だけで格安SIMを選ぶのは危険</strong></span>です。以下の3つのポイントも必ずチェックしてください。
...
**速度が安定しているキャリア**:
- ahamo、LINEMO、povo2.0（大手キャリアのサブブランド/オンライン専用）
- UQモバイル、ワイモバイル（大手キャリアのサブブランド）

**お昼に遅くなりやすいキャリア**:
- IIJmio、mineo、BIGLOBEモバイルなどのMVNO全般
...
- **店舗サポートあり**: UQモバイル、ワイモバイル、イオンモバイル、楽天モバイル
- **オンラインのみ**: ahamo、LINEMO、povo2.0、IIJmio、日本通信SIM
...
- **光回線セットが必須**: ワイモバイル、UQモバイルの最安料金は光回線セット割適用後
- **期間限定割引**: 「最初の6ヶ月だけ安い」パターンが多い
- **クレジットカード指定**: 特定のクレカ払いで割引されるケース

<span style="background: linear-gradient(transparent 60%, #ffd6e7 60%)"><strong>「割引後の料金」ではなく「割引なしの基本料金」で比較するのが、後悔しない選び方の鉄則です。</strong></span>

> 格安SIMの選び方をもっと詳しく知りたい方は、[用途別の格安SIM選び方完全ガイド](/yoto-betsu-kakuyasu-sim-erabikata/)をチェックしてみてください。
...
| 7-10GB | HISモバイル / IIJmio | 990円〜1,500円 | SNS・ニュース中心 |
...
格安SIMへの乗り換えで、<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>年間3万円〜6万円の節約</strong></span>は十分に実現可能です。この記事の一覧表を参考に、自分にぴったりのプランを見つけてください。

> UQモバイルの詳しい評判が気になる方は、[UQモバイルの評判・口コミまとめ](/uq-mobile-hyoban-kuchikomi/)もあわせてどうぞ。
...
<p style="margin: 8px 0; padding: 8px 0; border-bottom: 1px solid #e9ecef;">
  <a href="https://sim-hikaku.online/kakuyasu-sim-sokudo-ranking/" style="color: #0066CC; text-decoration: none; font-weight: 500;">格安SIM速度ランキング</a>
</p>

<p style="margin: 8px 0; padding: 8px 0; border-bottom: 1px solid #e9ecef;">
  <a href="https://sim-hikaku.online/kakuyasu-sim-campaign-matome/" style="color: #0066CC; text-decoration: none; font-weight: 500;">格安SIMキャンペーンまとめ</a>
</p>
...
<details>
<summary><strong>Q. 一覧表の料金は税込ですか？</strong></summary>
