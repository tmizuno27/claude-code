...
30GBで2,178円。マイネオ独自の「パケット放題Plus」（月385円追加で最大3Mbps使い放題）を組み合わせれば、実質的なデータ無制限に近い使い方も可能。
...
ワイモバイルの「家族割引サービス」は2回線目以降が毎月1,100円割引。シンプル3 Sプラン（5GB）なら<span style="background: linear-gradient(transparent 60%, #fff3cd 60%)"><strong>割引後1,958円/人</strong></span>で使えます。さらに「おうち割 光セット（A）」との併用で最大1,650円引きも。
