...
def fetch_search_console_data(secrets, days=7):
    ...
    try:
        response = service.searchanalytics().query(
            siteUrl="https://sim-hikaku.online/",
            body=body,
        ).execute()
...
def main():
    parser = argparse.ArgumentParser(description="Search Console 新規KW検出 (sim-hikaku.online)")
    ...
    logger.info("========== 新規KW検出 開始 (sim-hikaku.online) ==========")
