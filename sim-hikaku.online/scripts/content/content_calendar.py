...
CONFIG_PATH = PROJECT_ROOT / "config" / "content-calendar.json"
...
def main():
    """メイン処理"""
    logger.info("=== コンテンツカレンダー生成開始 (sim-hikaku.online) ===")
    ...
    keywords = assign_article_types(keywords[:12])
