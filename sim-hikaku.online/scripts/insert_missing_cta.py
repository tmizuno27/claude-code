...
creds = json.load(open('C:/Users/tmizu/マイドライブ/GitHub/claude-code/sim-hikaku.online/config/secrets.json', encoding='utf-8'))
links = json.load(open('C:/Users/tmizu/マイドライブ/GitHub/claude-code/sim-hikaku.online/config/affiliate-links.json', encoding='utf-8'))
