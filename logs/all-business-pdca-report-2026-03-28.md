...
Traceback (most recent call last):
  File "C:\Users\tmizu\マイドライブ\GitHub\claude-code\infrastructure\tools\seo-pdca\daily_all_business_pdca.py", line 1321, in main
    func()
    ~~~~^^
  File "C:\Users\tmizu\マイドライブ\GitHub\claude-code\infrastructure\tools\seo-pdca\daily_all_business_pdca.py", line 154, in pdca_blogs
  ...
  File "C:\Users\tmizu\AppData\Roaming\Python\Python313\site-packages\google\oauth2\service_account.py", line 262, in from_service_account_file
    ...
    ^
  File "C:\Users\tmizu\AppData\Roaming\Python\Python313\site-packages\google\auth\_service_account_info.py", line 78, in from_filename
    with io.open(filename, "r", encoding="utf-8") as json_file:
         ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
FileNotFoundError: [Errno 2] No such file or directory: 'C:\\Users\\tmizu\\マイドライブ\\GitHub\\claude-code\\infrastructure\\tools\\sheets-sync\\credentials\\service-account.json'
...
- 過去7日の投稿: **0件**
- 変換済みダイジェスト: 24件
- パイプライン最終実行: 2026-03-27 07:01 PYT
...
### CHECK
- **@nambei_oyaji**（ブログ集客）: 過去7日 12投稿 / エラー3件
- **@prodhq27**（Gumroad販促）: 過去7日 28投稿 / エラー8件
...
| ログ | 最終更新 | ステータス |
|------|---------|-----------|
| Git自動同期 | 03/28 06:44 | ✅ 正常 |
| SEO PDCA | 03/28 06:47 | ✅ 正常 |
| X投稿(@nambei) | 03/27 20:45 | ✅ 正常 |
| X投稿(@prodhq27) | 03/27 19:49 | ✅ 正常 |
| APIヘルスチェック | 03/28 06:00 | ✅ 正常 |
| ダッシュボード更新 | 03/28 06:00 | ✅ 正常 |
...
- HTMLファイル数: 8
  ...
  - `privacy-policy-whois-lookup.html`
  - `privacy-policy.html`
