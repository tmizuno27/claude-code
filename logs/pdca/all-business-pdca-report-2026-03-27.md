# 全事業 PDCA 日次レポート (2026-03-27)
実行時刻: 2026-03-27 06:30 PYT


# 古い記事・パフォーマンス低下 検出レポート (2026-03-27)

## 南米おやじ

### CTR改善候補（順位10位内・CTR<1%）: 3件
- `ai-app-sidejob` pos=9.6 CTR=0% imp=18
- `data-entry-automation` pos=6.1 CTR=0% imp=45
- `start-a-blog-from-abroad` pos=8 CTR=0% imp=14
...
### CTR改善候補（順位10位内・CTR<1%）: 1件
- `kakuyasu-sim-ryokin-hikaku-ichiran` pos=9.3 CTR=0% imp=146

---
*自動生成: 2026-03-27 06:30 PYT*
...
| 指標 | 今週 | 先週 | 変化 |
|------|-----:|-----:|-----:|
| インプレッション | 298 | 27 | +271 (+1004%) |
| クリック | 9 | 4 | +5 |

- GA4（7日間）: PV=158 / ユーザー=32 / セッション=41
...
| 指標 | 今週 | 先週 | 変化 |
|------|-----:|-----:|-----:|
| インプレッション | 183 | 2 | +181 (+9050%) |
| クリック | 2 | 0 | +2 |

- GA4（7日間）: PV=132 / ユーザー=46 / セッション=47

### ACT
- 公開記事数: 92
- 内部リンク不足（2本未満）: 3件
  - `30dai-dansei-konkatsu-app`
  - `konkatsu-30dai-dansei-nenshu`
  - `konkatsu-40dai-josei-batsuichi`
...
| 指標 | 今週 | 先週 | 変化 |
|------|-----:|-----:|-----:|
| インプレッション | 179 | 0 | +179 (+0%) |
| クリック | 0 | 0 | +0 |

- GA4（7日間）: PV=63 / ユーザー=44 / セッション=45

### ACT
- 公開記事数: 70
- 内部リンク不足（2本未満）: 3件
  - `kaigai-ryokou-kakuyasu-sim-esim-hikaku`
  - `au-kakuyasu-sim-kazokuwari-hikaku`
  - `kakuyasu-sim-osusume-2026`
...
- 過去7日の投稿: **0件**
- 変換済みダイジェスト: 22件
- パイプライン最終実行: 2026-03-26 07:39 PYT
...
### CHECK
- **@nambei_oyaji**（ブログ集客）: 過去7日 10投稿 / エラー2件
...
| ログ | 最終更新 | ステータス |
|------|---------|-----------|
| Git自動同期 | 03/27 06:44 | ✅ 正常 |
| SEO PDCA | 03/27 06:04 | ✅ 正常 |
| X投稿(@nambei) | 03/26 20:02 | ✅ 正常 |
| X投稿(@prodhq27) | 03/26 19:00 | ✅ 正常 |
| APIヘルスチェック | 03/27 06:00 | ✅ 正常 |
| ダッシュボード更新 | 03/27 06:24 | ✅ 正常 |
