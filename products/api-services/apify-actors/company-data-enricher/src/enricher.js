/**
 * Core enrichment logic for Company Data Enricher Apify Actor.
 * Ported from 20-company-data-api/src/enrichment.js and index.js,
...
/**
 * Fetch and parse website metadata from a URL.
...
/**
 * Full enrichment for a domain: metadata, tech stack, social links, contacts, RDAP.
 */
...
/**
 * Domain lookup: metadata + RDAP, without full tech detection.
 */
...
/**
 * Search for companies by name via Wikidata.
 */
...
/**
 * Get company details by Wikidata entity ID (e.g. 'Q95' for Google).
 */
export async function getWikidataEntity(wikidataId) {
  ...
  if (!entity || entity.missing !== undefined) {
    throw new Error(`Entity not found: ${wikidataId}`);
  }
