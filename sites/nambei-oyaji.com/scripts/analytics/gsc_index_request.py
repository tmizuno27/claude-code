...
# 認証設定
CREDENTIALS_FILE = r"C:\Users\tmizu\マイドライブ\GitHub\claude-code\sites\nambei-oyaji.com\config\ga4-credentials.json"
...
SITES = [
    {
        ...
        "csv": os.path.join(BASE, "sites", "nambei-oyaji.com", "outputs", "article-management.csv"),
    ...
    },
    {
        ...
        "csv": os.path.join(BASE, "sites", "otona-match.com", "outputs", "article-management.csv"),
    ...
    },
    {
        ...
        "csv": os.path.join(BASE, "sites", "sim-hikaku.online", "outputs", "article-management.csv"),
