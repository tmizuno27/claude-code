...
povo2.0は基本料0円のau回線プランです。<span style="background: linear-gradient(transparent 60%, #d6e4ff 60%)"><strong>最安のトッピング（データ使い放題（6時間）250円など）を180日に1回購入するだけで番号を維持できます</strong></span>。
